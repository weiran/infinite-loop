...
class GameScene: SKScene, SKPhysicsContactDelegate {
    ...
    func configureBackgroundCircle() {
    ...
    func configureScoreLabel() {
        ...
        scoreLabel.text = "0"
        scoreLabel.position = CGPointMake(frame.midX, frame.minY + 20)
